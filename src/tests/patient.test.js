...
describe('Patient', () => {
    ...
    test('renders ok', () => {
        ...
        expect(screen.getByText(/Diagnóstico/)).toBeInTheDocument(); //para encontrar elementos que si están, si se usa getBy con un elemento que no está siempre va a dar error
